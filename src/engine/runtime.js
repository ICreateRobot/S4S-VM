...
const ArgumentTypeMap = (() => {
    ...
    map[ArgumentType.NUMRES_1000_1000] = {
        shadow: {
            type: 'numresD1000D1000',
            fieldName: 'NUM'
        }
    };

    map[ArgumentType.NUMRES0_180] = {
        shadow: {
            type: 'numres0D180',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES0_99] = {
        shadow: {
            type: 'numres0D99',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES1_12] = {
        shadow: {
            type: 'numres1D12',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES1_31] = {
        shadow: {
            type: 'numres1D31',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES0_23] = {
        shadow: {
            type: 'numres0D23',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES0_59] = {
        shadow: {
            type: 'numres0D59',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES0_1] = {
        shadow: {
            type: 'numres0D1',
            fieldName: 'NUM'
        }
    };
    map[ArgumentType.NUMRES0_1023] = {
        shadow: {
            type: 'numres0D1023',
            fieldName: 'NUM'
        }
